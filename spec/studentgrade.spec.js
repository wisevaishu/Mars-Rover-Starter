...
describe("GRADING TEST: ", function() {
   ...
   it("Responds to TA message & commands", function() {
    ...
    //expect(JSON.parse(response.results[1].roverStatus).position).toEqual(4321);
    ...
    //expect(JSON.parse(response.results[4].roverStatus).position).toEqual(4321);

    expect(response.results[4].roverStatus.mode).toEqual('LOW_POWER');
    //expect(JSON.parse(response.results[4].roverStatus).mode).toEqual('LOW_POWER');

    expect(response.results[4].roverStatus.generatorWatts).toEqual(110);
    //expect(JSON.parse(response.results[4].roverStatus).generatorWatts).toEqual(110);
